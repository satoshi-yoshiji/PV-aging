...
- **Supplementary Table S4.** `Table_S4_bioage_proxy.csv` - OLS beta-per-SD endotrophin for the lab-based biological-age composite and its chronological-age-residualised "delta-bioage" counterpart.
