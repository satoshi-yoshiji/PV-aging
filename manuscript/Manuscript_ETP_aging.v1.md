...
![Figure 1 -- Endotrophin and cross-sectional aging proxies at baseline. **a**, Distribution of the 2-year baseline cumulative HFRS in the analytic cohort. **b**, beta-per-SD endotrophin for continuous baseline HFRS across the three nested adjustment models. **c**, Logistic-regression OR-per-SD endotrophin for prevalent frailty-syndrome ICD-10 flags at baseline.](figures/Figure_1_cross_sectional.png)
