...
ENDPOINT_DESCRIPTIONS = {
    ...
    "stroke":           ("Stroke",
                         "I60 - I69",
                         "Cerebrovascular-disease block; covers haemorrhagic, ischaemic, sequelae."),
    ...
    "cancer":           ("Cancer (Zenin component)",
                         "C00 - C97, D00 - D48",
                         "Malignant (C*) and in-situ / uncertain-behaviour (D00-D48) neoplasms."),
    "hip_fracture":     ("Frailty syndrome: hip fracture",
                         "S72*",
                         "All sub-codes of S72 (femur fractures including neck/shaft)."),
